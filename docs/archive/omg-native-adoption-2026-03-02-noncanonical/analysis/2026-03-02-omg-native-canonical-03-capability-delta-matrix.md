...
|---|---|---|---|---|
<<<<<<< HEAD
| CMD-01 | `team run` is the only lifecycle operator command | Add `team status`, `team resume`, `team shutdown` | PAR-CLI-01/02/03 | `src/cli/index.ts`, `src/cli/commands/team-*.ts`, `extensions/oh-my-antigravity/commands/team/*`, `docs/omg/commands.md` |
...
| CMD-03 | Extension command set has limited lifecycle control | Extension command prompts and CLI help remain aligned | PAR-CLI-01..04 | `extensions/oh-my-antigravity/commands/**`, `docs/omg/commands.md` |
=======
