...
|---|---|
<<<<<<< HEAD
| CLI lifecycle commands | `src/cli/index.ts`, `src/cli/commands/team-*.ts`, `docs/omg/commands.md`, `extensions/oh-my-antigravity/commands/team/*.toml` |
...
| Role/skill contracts | `src/team/subagents-catalog.ts`, `src/team/subagents-blueprint.ts`, `extensions/oh-my-antigravity/skills/*` |
=======
