...
## Quick Start
1. Reproduce the problem or gather the smallest failing evidence.
2. Narrow the cause with file, command, and output evidence.
3. Apply the minimum credible fix.
